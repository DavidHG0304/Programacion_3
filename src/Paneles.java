...
public class Paneles extends JFrame {
	...
	public Paneles() {
		...
		menuPregunta1.addActionListener(new ActionListener() {
		...
		menuPregunta2.addActionListener(new ActionListener() {
		...
		menuPregunta3.addActionListener(new ActionListener() {
	...
	public void login(JFrame frame) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Error al ingresar las credenciales", "Alerta",
	...
	public void registro(JFrame frame) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if ((contrasenia.equals(contraseniaConfirmar)) && (!contrasenia.equals(""))
						&& (contrasenia.length() >= 8 && contraseniaConfirmar.length() >= 8)) {
					JOptionPane.showMessageDialog(null, "Success", "Se ha registrado con exito",
							JOptionPane.INFORMATION_MESSAGE);
				} else if (contrasenia.isEmpty() && contraseniaConfirmar.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Escriba una contraseña", "Alerta",
							JOptionPane.WARNING_MESSAGE);
				} else if (contrasenia.length() < 8 && contraseniaConfirmar.length() < 8) {
					JOptionPane.showMessageDialog(null, "Su contraseña debe ser mayor a 8 caracteres", "Error",
	...
	public void altaCuenta(JFrame frame) {
		...
		contentPane.setLayout(new BorderLayout(0, 0));
		JPanel panelEnPanalla = new JPanel();
		panelEnPanalla.setBackground(new Color(202, 20, 58));
		contentPane.add(panelEnPanalla, BorderLayout.CENTER);
		panelEnPanalla.setLayout(null);
	...
	public void bajaCuenta(JFrame frame) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 507, 613);
		contentPane = new JPanel();
		contentPane.setBackground(new Color(0, 0, 0));
		...
		contentPane.setLayout(new BorderLayout(0, 0));
		JPanel panelEnPanalla = new JPanel();
		panelEnPanalla.setBackground(new Color(22, 40, 128));
		contentPane.add(panelEnPanalla, BorderLayout.CENTER);
		panelEnPanalla.setLayout(null);
		JLabel lblNewLabel = new JLabel("Baja Cuenta");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 39));
		lblNewLabel.setBounds(82, 23, 315, 116);
	...
	public void consultar(JFrame frame) {
		...
		contentPane.setLayout(new BorderLayout(0, 0));
		JPanel panelEnPanalla = new JPanel();
		panelEnPanalla.setBackground(new Color(102, 120, 20));
		contentPane.add(panelEnPanalla, BorderLayout.CENTER);
		panelEnPanalla.setLayout(null);
	...
	public void pregunta1(JFrame frame) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 507, 613);
		contentPane = new JPanel();
		contentPane.setBackground(new Color(0, 0, 0));
		...
		contentPane.setLayout(new BorderLayout(0, 0));
		JPanel panelEnPanalla = new JPanel();
		panelEnPanalla.setBackground(new Color(52, 150, 52));
		contentPane.add(panelEnPanalla, BorderLayout.CENTER);
		panelEnPanalla.setLayout(null);
		...
		lblNewLabel.setBounds(0, 23, 475, 116);
		panelEnPanalla.add(lblNewLabel);
	}

	public void pregunta2(JFrame frame) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 507, 613);
		contentPane = new JPanel();
		contentPane.setBackground(new Color(0, 0, 0));
		...
		contentPane.setLayout(new BorderLayout(0, 0));
		JPanel panelEnPanalla = new JPanel();
		panelEnPanalla.setBackground(new Color(72, 150, 120));
		contentPane.add(panelEnPanalla, BorderLayout.CENTER);
		panelEnPanalla.setLayout(null);
	...
	public void pregunta3(JFrame frame) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 507, 613);
		contentPane = new JPanel();
		contentPane.setBackground(new Color(0, 0, 0));
		...
		contentPane.setLayout(new BorderLayout(0, 0));
		JPanel panelEnPanalla = new JPanel();
		panelEnPanalla.setBackground(new Color(160, 10, 10));
		contentPane.add(panelEnPanalla, BorderLayout.CENTER);
		panelEnPanalla.setLayout(null);
